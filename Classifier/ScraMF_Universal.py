...
def train_model_classifer(adata_training, epochs=20, max_depth=10, eta=0.15, predict=False):
    """ Train models for classifying cells into males and females through scramf_universal function"""
...
def scramf_universal(adata_test, model_softmax, model_softprob, class_prob_cutoff=0.85):
